...
// Eags: total coins staked (non-spendable until maturity)
...
// Eags: check 'spent' consistency between wallet and txindex
// Eags: fix wallet spent state according to txindex
...
// Eags: disable transaction (only for coinstake)
